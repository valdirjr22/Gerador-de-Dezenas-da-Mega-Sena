...
<head>
    ...
    <title>Gerador de Dezenas da Mega-Sena</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        body {
            font-family: 'Inter', sans-serif;
        }
        /* Estilos adicionais para garantir que os cantos sejam arredondados em todos os elementos */
        .rounded-lg, .rounded-md, .rounded-xl, .rounded-2xl, .rounded-full {
            border-radius: 0.5rem; /* Ajuste conforme necessário para o seu design */
        }
    </style>
</head>
<body class="min-h-screen bg-gray-100 p-4 flex items-center justify-center">
    <div class="bg-white p-6 md:p-8 rounded-lg shadow-md w-full max-w-4xl">
        ...
        <p class="text-center text-gray-600 mb-6 max-w-2xl mx-auto">
            Utilize este aplicativo para gerar dezenas da Mega-Sena com base na frequência de números sorteados em concursos anteriores.
        </p>
        ...
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded mb-6">
            ...
            <p class="text-sm">
                A Mega-Sena é um jogo de azar e cada sorteio é independente. Este programa utiliza estatísticas de sorteios passados para sugerir dezenas, mas não há garantia de que números que saíram com frequência no passado continuarão a sair no futuro. Jogue com responsabilidade.
            </p>
        </div>

        <div class="mb-6 bg-blue-50 p-5 rounded-lg shadow-inner">
            <h2 class="text-xl md:text-2xl font-bold text-blue-800 mb-4">
                Como Usar:
            </h2>
            <ol class="list-decimal list-inside text-gray-700 space-y-2">
                <li>
                    <span class="font-semibold">Visualize os Sorteios Anteriores:</span> Os resultados dos concursos da Mega-Sena estão pré-carregados na caixa de texto abaixo.
                </li>
                <li>
        ...
        <div class="mb-6 bg-gray-50 p-5 rounded-lg shadow-inner">
            <label for="pastDraws" class="block text-gray-700 text-lg font-bold mb-3">
                1. Resultados dos Sorteios Anteriores:
            </label>
            <textarea
                id="pastDraws"
                class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800 h-60 resize-y"
                readonly
            ></textarea>
        ...
        <div class="mb-6 bg-gray-50 p-5 rounded-lg shadow-inner">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mb-4">
                <div class="flex-1">
                    ...
                    <select
                        id="filterMonth"
                        class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800 bg-white"
                    >
            ...
            <p id="filterMessage" class="text-red-600 text-sm mt-2 font-medium"></p>
        </div>

        <div id="frequencyAnalysisSection" class="mb-6 bg-gray-50 p-5 rounded-lg shadow-inner hidden">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4">
                3. Análise de Frequência dos Números (Sorteios Filtrados):
            </h2>
            <div id="mostCommonNumbersContainer" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                </div>
            <p id="frequencyDisplayMessage" class="text-gray-600 text-sm mt-3 text-center hidden">
                Exibindo os 20 números mais frequentes.
            </p>
        </div>

        <div id="filteredDrawsDisplaySection" class="mb-6 bg-gray-50 p-5 rounded-lg shadow-inner hidden">
            <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4">
                Sorteios Filtrados:
            </h2>
            <div id="filteredDrawsContainer" class="max-h-60 overflow-y-auto border border-gray-300 rounded-md p-3 bg-white">
                </div>
        </div>
        ...
        <div class="mb-6 bg-gray-50 p-5 rounded-lg shadow-inner">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-4 mb-4">
                <div class="flex-1">
                    ...
                    <input
                        type="number"
                        id="numGames"
                        class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800"
                        min="1"
                        max="10"
                        value="1"
                    />
            ...
            <button
                id="generateButton"
                class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-md shadow-md transition duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
                Gerar Dezenas
            </button>
        </div>

        <div id="generatedGamesSection" class="bg-green-50 p-5 rounded-lg shadow-md border border-green-200 hidden">
            <h2 class="text-xl md:text-2xl font-bold text-green-800 mb-4">
                5. Seus Jogos Gerados:
            </h2>
            <div id="generatedGamesContainer" class="grid grid-cols-1 gap-4">
                </div>
        </div>
    </div>
    ...
    <script>
        ...
        let pastDrawsInput = `Janeiro/2015
...
07 18 20 26 38 51
Concurso: 2680 - 25/01/2024 (Quinta)
03 11 42 45 46 57
...
01 11 19 20 28 48
Concurso: 2701 - 16/03/2024 (Sábado)
06 15 18 31 32 47
Concurso: 2702 - 19/03/2024 (Terça)
06 13 20 34 40 46
Concurso: 2703 - 21/03/2024 (Quinta)
03 07 11 35 38 56
Concurso: 2704 - 23/03/2024 (Sábado)
03 07 10 25 31 52
Concurso: 2705 - 26/03/2024 (Terça)
02 16 22 27 35 47
Concurso: 2706 - 30/03/2024 (Sábado)
10 11 17 24 30 45
Abril/2024
Concurso: 2707 - 02/04/2024 (Terça)
07 09 11 39 54 57
Concurso: 2708 - 04/04/2024 (Quinta)
10 11 12 19 23 28
Concurso: 2709 - 06/04/2024 (Sábado)
12 22 23 24 47 53
Concurso: 2710 - 09/04/2024 (Terça)
05 06 25 42 44 50
Concurso: 2711 - 11/04/2024 (Quinta)
14 36 38 46 55 60
Concurso: 2712 - 13/04/2024 (Sábado)
07 15 19 35 40 42
Concurso: 2713 - 16/04/2024 (Terça)
09 23 25 26 35 58
Concurso: 2714 - 18/04/2024 (Quinta)
16 17 42 45 52 57
Concurso: 2715 - 20/04/2024 (Sábado)
07 19 25 46 50 53
Concurso: 2716 - 23/04/2024 (Terça)
05 20 27 28 48 49
Concurso: 2717 - 25/04/2024 (Quinta)
06 22 34 36 44 50
Concurso: 2718 - 27/04/2024 (Sábado)
06 30 34 41 46 59
Concurso: 2719 - 30/04/2024 (Terça)
16 25 27 30 42 48
Maio/2024
Concurso: 2720 - 04/05/2024 (Sábado)
08 15 16 23 42 43
Concurso: 2721 - 07/05/2024 (Terça)
09 10 11 25 46 48
Concurso: 2722 - 09/05/2024 (Quinta)
19 23 25 36 44 46
Concurso: 2723 - 11/05/2024 (Sábado)
06 12 19 28 50 60
Concurso: 2724 - 14/05/2024 (Terça)
11 21 24 26 42 54
Concurso: 2725 - 16/05/2024 (Quinta)
02 10 32 33 38 47
Concurso: 2726 - 18/05/2024 (Sábado)
27 45 49 53 55 59
Concurso: 2727 - 21/05/2024 (Terça)
04 32 39 48 51 57
Concurso: 2728 - 23/05/2024 (Quinta)
02 09 11 25 43 51
Concurso: 2729 - 25/05/2024 (Sábado)
20 27 41 47 53 54
Concurso: 2730 - 28/05/2024 (Terça)
07 24 29 41 46 60
Junho/2024
Concurso: 2731 - 01/06/2024 (Sábado)
04 12 32 45 49 58
Concurso: 2732 - 04/06/2024 (Terça)
01 03 16 18 49 60
Concurso: 2733 - 06/06/2024 (Quinta)
14 20 21 39 44 56
Concurso: 2734 - 08/06/2024 (Sábado)
21 27 35 48 59 60
Concurso: 2735 - 11/06/2024 (Terça)
05 33 46 47 53 59
Concurso: 2736 - 13/06/2024 (Quinta)
11 17 24 26 35 43
Concurso: 2737 - 15/06/2024 (Sábado)
16 20 30 34 37 45
Concurso: 2738 - 18/06/2024 (Terça)
02 19 25 44 46 60
Concurso: 2739 - 20/06/2024 (Quinta)
19 25 37 45 47 53
Concurso: 2740 - 22/06/2024 (Sábado)
13 16 17 34 41 47
Concurso: 2741 - 25/06/2024 (Terça)
01 33 35 39 42 56
Concurso: 2742 - 27/06/2024 (Quinta)
02 11 25 32 37 57
Concurso: 2743 - 29/06/2024 (Sábado)
13 25 27 30 37 53
Julho/2024
Concurso: 2744 - 02/07/2024 (Terça)
10 25 26 33 34 38
Concurso: 2745 - 04/07/2024 (Quinta)
02 05 07 11 52 57
Concurso: 2746 - 06/07/2024 (Sábado)
22 27 30 43 51 56
Concurso: 2747 - 10/07/2024 (Quarta)
14 17 24 28 36 45
Concurso: 2748 - 13/07/2024 (Sábado)
19 32 43 46 50 52
Concurso: 2749 - 16/07/2024 (Terça)
08 25 27 38 43 44
Concurso: 2750 - 18/07/2024 (Quinta)
07 11 12 19 36 52
Concurso: 2751 - 20/07/2024 (Sábado)
04 13 18 42 52 53
Concurso: 2752 - 23/07/2024 (Terça)
04 15 24 40 44 47
Concurso: 2753 - 25/07/2024 (Quinta)
06 26 31 46 52 55
Concurso: 2754 - 27/07/2024 (Sábado)
10 14 44 55 56 58
Concurso: 2755 - 30/07/2024 (Terça)
07 13 17 33 41 58
Agosto/2024
Concurso: 2756 - 01/08/2024 (Quinta)
01 06 13 18 43 46
Concurso: 2757 - 03/08/2024 (Sábado)
01 21 37 40 51 54
Concurso: 2758 - 06/08/2024 (Terça)
19 35 36 37 41 60
Concurso: 2759 - 08/08/2024 (Quinta)
03 10 38 40 48 59
Concurso: 2760 - 10/08/2024 (Sábado)
08 11 19 39 47 48
Concurso: 2761 - 13/08/2024 (Terça)
03 22 34 44 49 57
Concurso: 2762 - 15/08/2024 (Quinta)
01 17 30 40 48 50
Concurso: 2763 - 17/08/2024 (Sábado)
15 16 19 43 44 49
Concurso: 2764 - 20/08/2024 (Terça)
20 31 34 38 42 51
Concurso: 2765 - 22/08/2024 (Quinta)
08 12 34 39 43 47
Concurso: 2766 - 24/08/2024 (Sábado)
09 10 34 36 38 44
Concurso: 2767 - 27/08/2024 (Terça)
14 21 42 47 50 59
Concurso: 2768 - 29/08/2024 (Quinta)
02 12 18 28 32 33
Concurso: 2769 - 31/08/2024 (Sábado)
10 16 35 46 49 60
Setembro/2024
Concurso: 2770 - 03/09/2024 (Terça)
21 28 37 44 50 60
Concurso: 2771 - 06/09/2024 (Sexta)
07 13 14 33 38 50
Concurso: 2772 - 10/09/2024 (Terça)
01 12 33 41 53 56
Concurso: 2773 - 12/09/2024 (Quinta)
19 23 32 34 38 57
Concurso: 2774 - 14/09/2024 (Sábado)
06 16 22 24 38 50
Concurso: 2775 - 17/09/2024 (Terça)
01 04 14 26 44 51
Concurso: 2776 - 19/09/2024 (Quinta)
05 17 22 37 51 52
Concurso: 2777 - 21/09/2024 (Sábado)
02 13 21 38 42 52
Concurso: 2778 - 24/09/2024 (Terça)
20 33 34 40 43 57
Concurso: 2779 - 26/09/2024 (Quinta)
14 19 32 44 51 54
Concurso: 2780 - 28/09/2024 (Sábado)
07 09 10 14 46 53
Outubro/2024
Concurso: 2781 - 01/10/2024 (Terça)
10 31 35 45 50 55
Concurso: 2782 - 03/10/2024 (Quinta)
06 11 16 25 28 45
Concurso: 2783 - 05/10/2024 (Sábado)
07 30 38 39 43 54
Concurso: 2784 - 08/10/2024 (Terça)
27 30 35 44 57 59
Concurso: 2785 - 11/10/2024 (Sexta)
20 27 48 50 57 59
Concurso: 2786 - 16/10/2024 (Quarta)
06 11 17 20 40 51
Concurso: 2787 - 19/10/2024 (Sábado)
08 10 23 34 36 50
Concurso: 2788 - 22/10/2024 (Terça)
23 37 39 47 52 56
Concurso: 2789 - 24/10/2024 (Quinta)
03 17 18 19 20 55
Concurso: 2790 - 26/10/2024 (Sábado)
29 32 40 42 49 58
Concurso: 2791 - 29/10/2024 (Terça)
02 03 11 25 37 43
Novembro/2024
Concurso: 2792 - 01/11/2024 (Sexta)
16 22 33 34 49 59
Concurso: 2793 - 05/11/2024 (Terça)
07 09 25 37 57 59
Concurso: 2794 - 07/11/2024 (Quinta)
03 09 14 20 28 52
Concurso: 2795 - 09/11/2024 (Sábado)
13 16 33 43 46 55
Concurso: 2796 - 13/11/2024 (Quarta)
03 06 14 33 55 58
Concurso: 2797 - 16/11/2024 (Sábado)
01 03 15 25 45 52
Concurso: 2798 - 19/11/2024 (Terça)
03 09 18 54 59 60
Concurso: 2799 - 23/11/2024 (Sábado)
01 31 38 40 45 60
Concurso: 2800 - 26/11/2024 (Terça)
01 13 19 46 50 57
Concurso: 2801 - 28/11/2024 (Quinta)
25 27 33 46 48 56
Concurso: 2802 - 30/11/2024 (Sábado)
17 21 26 28 32 60
Dezembro/2024
Concurso: 2803 - 03/12/2024 (Terça)
01 20 32 43 57 59
Concurso: 2804 - 05/12/2024 (Quinta)
14 24 25 31 33 60
Concurso: 2805 - 07/12/2024 (Sábado)
01 06 24 47 55 58
Concurso: 2806 - 10/12/2024 (Terça)
05 11 13 33 45 46
Concurso: 2807 - 12/12/2024 (Quinta)
08 25 49 52 55 56
Concurso: 2808 - 14/12/2024 (Sábado)
10 24 33 35 41 46
Concurso: 2809 - 17/12/2024 (Terça)
02 04 15 28 34 39
Concurso: 2810 - 31/12/2024 (Terça)
01 17 19 29 50 57
Janeiro/2025
...
05 09 15 24 25 60`;
        ...
        let frequencyCounts = [];
        let generatedGames = [];
        let numGamesToGenerate = 1;
        let generationStrategy = 'frequencia';
        let errorMessage = '';
        ...
        /**
         * Analisa a string de entrada de sorteios anteriores e a converte em um array de objetos.
         * Cada objeto contém a data do sorteio e os números sorteados.
         * @param {string} input A string de texto bruta fornecida pelo utilizador.
         * @returns {Array<{date: Date, numbers: Array<number>}>} Um array de objetos, cada um representando um sorteio.
         */
        function parseAllDraws(input) {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (line.startsWith('Concurso:') && dateMatch) {
                    const [day, month, year] = dateMatch[1].split('/').map(Number);
                    // Cria um objeto Date (o mês é baseado em 0 no Date do JS)
                    const currentDate = new Date(year, month - 1, day);
                    // Avança para a próxima linha para obter os números
                    if (i + 1 < lines.length) {
                        const numbersLine = lines[++i]; // Incrementa i para consumir a próxima linha
                        const numbers = numbersLine.split(/\D+/).filter(Boolean).map(Number);

                        const validNumbers = numbers.filter(num => num >= 1 && num <= 60);

                        if (validNumbers.length !== 6) {
                            errors.push(`Erro na linha após a data ${dateMatch[1]}: Deve conter exatamente 6 números entre 1 e 60. Encontrados ${validNumbers.length}.`);
                        } else if (new Set(validNumbers).size !== 6) {
                            errors.push(`Erro na linha após a data ${dateMatch[1]}: Contém números duplicados.`);
                        } else {
                            draws.push({ date: currentDate, numbers: validNumbers.sort((a, b) => a - b) });
                        }
                    } else {
                        errors.push(`Erro: Linha de concurso encontrada sem números correspondentes no final da entrada.`);
                    }
                }
            }
        ...
        /**
         * Calcula a frequência de cada número dos sorteios fornecidos.
         * @param {Array<{date: Date, numbers: Array<number>}>} draws O array de sorteios a analisar.
         * @returns {Array<[number, number]>} Um array ordenado de pares [número, frequência].
         */
        function calculateFrequency(draws) {
            const counts = new Map();
            // Inicializa todos os números de 1 a 60 com uma frequência de 0
            for (let i = 1; i <= 60; i++) {
                counts.set(i, 0);
            }
            ...
            // Converte o mapa para um array e ordena por frequência (descendente) e depois por número (ascendente)
            return Array.from(counts.entries()).sort((a, b) => {
                if (b[1] !== a[1]) {
                    return b[1] - a[1]; // Ordena por frequência (descendente)
                }
                return a[0] - b[0]; // Depois por número (ascendente)
            });
        }

        /**
         * Gera um único jogo da Mega-Sena com base na estratégia escolhida.
         * @param {string} strategy A estratégia de geração ('frequencia' ou 'ponderada').
         * @param {Array<[number, number]>} frequencies As contagens de frequência ordenadas.
         * @returns {Array<number>} Um array ordenado de 6 números únicos da Mega-Sena.
         */
        function generateSingleGame(strategy, frequencies) {
            let game = new Set();
            const availableNumbers = Array.from({ length: 60 }, (_, i) => i + 1); // Números de 1-60

            if (strategy === 'frequencia') {
                // Obtém os 6 números mais frequentes
                const topNumbers = frequencies.slice(0, 6).map(item => item[0]);
                game = new Set(topNumbers);

                // Se não houver números únicos suficientes, preenche com números aleatórios únicos
                while (game.size < 6) {
                    const remainingNumbers = availableNumbers.filter(num => !game.has(num));
                    if (remainingNumbers.length === 0) break; // Não deve acontecer para o intervalo de 1-60
                    game.add(remainingNumbers[Math.floor(Math.random() * remainingNumbers.length)]);
                }
            } else if (strategy === 'ponderada') {
                // Cria uma lista ponderada de números com base na sua frequência
                ...
                // Se não houver sorteios anteriores ou números únicos suficientes na lista ponderada, retorna para aleatório
                if (weightedNumbers.length < 6) {
                    while (game.size < 6) {
                        game.add(availableNumbers[Math.floor(Math.random() * availableNumbers.length)]);
                    }
                } else {
                    while (game.size < 6) {
                        // Escolhe um número aleatório da lista ponderada
                        const selectedNum = weightedNumbers[Math.floor(Math.random() * weightedNumbers.length)];
                        game.add(selectedNum);
                    }
                }
            }
        ...
        /**
         * Lida com a geração de múltiplos jogos da Mega-Sena.
         */
        function handleGenerateGames() {
            if (filteredDraws.length === 0) {
                errorMessage = 'Nenhum sorteio encontrado para os filtros selecionados. Por favor, ajuste os filtros ou insira mais dados.';
                generatedGames = [];
                renderApp();
                return;
            }
            ...
            for (let i = 0; i < numGamesToGenerate; i++) {
                games.push(generateSingleGame(generationStrategy, frequencyCounts));
            }
        ...
        /**
         * Renderiza a interface do utilizador com base no estado atual da aplicação.
         */
        function renderApp() {
            // Atualiza a área de texto dos sorteios anteriores
            document.getElementById('pastDraws').value = pastDrawsInput;
            ...
            const years = new Set(allParsedDraws.map(draw => draw.date.getFullYear().toString()));
            ...
            // Define o valor selecionado para o ano
            filterYearSelect.value = selectedYear;

            // Define o valor selecionado para o mês
            document.getElementById('filterMonth').value = selectedMonth;

            // Atualiza a mensagem de filtro
            const filterMessageElement = document.getElementById('filterMessage');
            if (filteredDraws.length === 0 && allParsedDraws.length > 0 && (selectedMonth !== 'all' || selectedYear !== 'all')) {
                filterMessageElement.textContent = 'Nenhum sorteio encontrado para os filtros selecionados.';
                filterMessageElement.classList.remove('hidden');
            } else {
                filterMessageElement.textContent = '';
                filterMessageElement.classList.add('hidden');
            }

            // Renderiza a seção de análise de frequência
            const frequencyAnalysisSection = document.getElementById('frequencyAnalysisSection');
            const mostCommonNumbersContainer = document.getElementById('mostCommonNumbersContainer');
            const frequencyDisplayMessage = document.getElementById('frequencyDisplayMessage');

            mostCommonNumbersContainer.innerHTML = '';
            if (frequencyCounts.length > 0 && filteredDraws.length > 0) {
                frequencyAnalysisSection.classList.remove('hidden');
                const mostCommonNumbers = frequencyCounts.slice(0, 20); // Exibe os 20 mais frequentes
                mostCommonNumbers.forEach(([num, freq]) => {
                    const div = document.createElement('div');
                    div.className = 'bg-blue-100 p-3 rounded-md text-center shadow-sm border border-blue-200';
                    div.innerHTML = `<span class="font-bold text-blue-700 text-lg">${String(num).padStart(2, '0')}</span>
                                     <span class="text-gray-600 text-sm block">(${freq} vezes)</span>`;
                    mostCommonNumbersContainer.appendChild(div);
                });
                frequencyDisplayMessage.classList.toggle('hidden', frequencyCounts.length <= 20);
            } else {
                frequencyAnalysisSection.classList.add('hidden');
            }

            // Renderiza a seção de sorteios filtrados
            const filteredDrawsDisplaySection = document.getElementById('filteredDrawsDisplaySection');
            const filteredDrawsContainer = document.getElementById('filteredDrawsContainer');
            filteredDrawsContainer.innerHTML = '';
            if (filteredDraws.length > 0) {
                filteredDrawsDisplaySection.classList.remove('hidden');
                filteredDraws.forEach((draw, index) => {
                    const div = document.createElement('div');
                    div.className = 'mb-2 p-2 border-b border-gray-200 last:border-b-0';
                    div.innerHTML = `<p class="text-gray-700 font-semibold">
                                        ${draw.date.toLocaleDateString('pt-BR', { year: 'numeric', month: '2-digit', day: '2-digit' })}:
                                        <span class="ml-2 font-bold text-green-600">
                                            ${draw.numbers.map(num => String(num).padStart(2, '0')).join(' ')}
                                        </span>
                                    </p>`;
                    filteredDrawsContainer.appendChild(div);
                });
            } else {
                filteredDrawsDisplaySection.classList.add('hidden');
            }

            // Atualiza as opções de geração
            document.getElementById('numGames').value = numGamesToGenerate;
            document.getElementById('strategy').value = generationStrategy;

            // Renderiza a seção de jogos gerados
            const generatedGamesSection = document.getElementById('generatedGamesSection');
            const generatedGamesContainer = document.getElementById('generatedGamesContainer');
            generatedGamesContainer.innerHTML = '';
            if (generatedGames.length > 0) {
                generatedGamesSection.classList.remove('hidden');
                generatedGames.forEach((game, index) => {
                    const div = document.createElement('div');
                    div.className = 'bg-white p-4 rounded-md shadow-sm border border-green-100 flex flex-wrap items-center justify-center gap-3';
                    div.innerHTML = `<span class="text-gray-700 font-semibold mr-2">Jogo ${index + 1}:</span>
                                     ${game.map(num => `<span class="bg-green-500 text-white font-bold text-lg w-10 h-10 flex items-center justify-center rounded-full shadow-md">
                                            ${String(num).padStart(2, '0')}
                                        </span>`).join('')}`;
                    generatedGamesContainer.appendChild(div);
                });
            } else {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Inicializa os dados e renderiza a primeira vez
            allParsedDraws = parseAllDraws(pastDrawsInput);
            
            // Define os anos disponíveis para o filtro
            const years = new Set(allParsedDraws.map(draw => draw.date.getFullYear().toString()));
            const availableYears = ['all', ...Array.from(years).sort((a, b) => Number(b) - Number(a))];
            const filterYearSelect = document.getElementById('filterYear');
            filterYearSelect.innerHTML = '<option value="all">Todos os Anos</option>';
            ...
            // Aplica os filtros iniciais e calcula a frequência
            let currentFilteredDraws = allParsedDraws;
            if (selectedYear !== 'all') {
                currentFilteredDraws = currentFilteredDraws.filter(draw =>
                    draw.date.getFullYear().toString() === selectedYear
                );
            }
            if (selectedMonth !== 'all') {
                currentFilteredDraws = currentFilteredDraws.filter(draw =>
                    (draw.date.getMonth() + 1).toString().padStart(2, '0') === selectedMonth
                );
            }
            filteredDraws = currentFilteredDraws;
            frequencyCounts = calculateFrequency(filteredDraws);
            ...
            document.getElementById('numGames').addEventListener('change', (e) => {
                numGamesToGenerate = Math.max(1, Math.min(10, Number(e.target.value)));
                renderApp();
            });

            document.getElementById('strategy').addEventListener('change', (e) => {
                generationStrategy = e.target.value;
                renderApp();
            });

            document.getElementById('generateButton').addEventListener('click', handleGenerateGames);
        });
    </script>
</body>
</html>
